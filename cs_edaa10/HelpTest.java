...
/**
 * Testprogram f�r att kolla att installationen av hj�lpklasserna
 * fungerar, CLASSPATH �r r�tt, osv
 */

public class HelpTest {
    public static void main(String[] args) {
        System.out.println("Detta program testar att klasserna SimpleWindow,");
        System.out.println("SimpleRandom och SimpleInput �r korrekt installerade");
        System.out.println("Programmet ritar ett antal linjer med slumpm�ssiga" +
                " f�rger");
        System.out.println();
